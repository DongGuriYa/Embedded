...
LAYER_FRAME Fb_Layer = (LAYER_FRAME)LCD_FB0;
...
{
	// 최대 640 * 480으로 고려
	Lcd_Set_Address(LCD_FB0 + ((y * Virtual_X) + (x*3)) * 4);
}

void Lcd_Select_Draw_Frame_Buffer(unsigned int id)
{
   	Fb_Layer = (LAYER_FRAME)(LCD_FB0+LCD_SIZE*id);
   	Selected_frame = id;
}
...
//////////////////// GBOX Camera Diapley Related Library ////////////////////////
